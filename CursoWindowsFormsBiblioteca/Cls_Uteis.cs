...
namespace CursoWindowsFormsBiblioteca
{
    ...
    {
        public static string[] login = new string[1000000];
        public static string[] senha = new string[1000000];
        public static int indiceCriar = 0;
        public static string criarSenhaLogin(string Nlogin, string Nsenha)
        {
            login[indiceCriar] = Nlogin;
            senha[indiceCriar] = Nsenha;
            indiceCriar++;
            return "Senha criada";
        }
        public static bool validaSenhaLogin(string Clogin, string Csenha)
        {
            int i = 0; ;
            string loginVerificar;
            string senhaVereficar;
            while (i != indiceCriar)
            {
                loginVerificar = login[i];
                senhaVereficar = senha[i];
                i++;
                if (Clogin == loginVerificar && Csenha == senhaVereficar)
