...
namespace CursoWindowsForms
{
    public partial class Frm_Principal_Menu_UC : Form
    {
        ...
        private void desconectarToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            while (!(Tbc_Aplicacoes.SelectedTab == null))
            {
                Tbc_Aplicacoes.TabPages.Remove(Tbc_Aplicacoes.SelectedTab);
            }
        }

        private void criarLoginToolStripMenuItem_Click(object sender, EventArgs e)
        {
            Frm_Login f = new Frm_Login();
            f.ShowDialog();
            if (f.DialogResult == DialogResult.OK)
            {
                string senha = f.senha;
                string login = f.login;
                MessageBox.Show(CursoWindowsFormsBiblioteca.Cls_Uteis.criarSenhaLogin(login, senha), "Mensagem", MessageBoxButtons.OK, MessageBoxIcon.Information); 
